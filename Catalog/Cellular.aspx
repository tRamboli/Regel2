<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cellular.aspx.cs" Inherits="Catalog_Cellular" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>מוצרי יד שניה - סלולארי</title>
...
<body background="../pic/bak.jpg" style="background-attachment: fixed; background-repeat: no-repeat;">
    ...
    <div style="width: 70.1%; margin: 0 auto; background-color: #E9E9E9; line-height: 100%;
        ...
        <span class="style3" style="display: block; text-align: right; padding-top: 15px;">&nbsp;סלולארי</span>
        <hr />
        <br />
        <br />
          <center >
         <asp:GridView ID="prodview" runat="server" AutoGenerateColumns="False" 
                ...
                CellSpacing="4" DataSourceID="SqlDataSource2" EnableModelValidation="True" 
                ForeColor="#333333" GridLines="Vertical" 
                onrowcommand="prodview_RowCommand" style="width :90%; margin-bottom :30px;">
...
WHERE (((TblDetailType.typeproname)='סלולארי'))
