<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Electric.aspx.cs" Inherits="Catalog_Electric" %>
...
<body background="../pic/bak.jpg" style="background-attachment: fixed; background-repeat: no-repeat;">
    ...
    <div style="width: 70.1%; margin: 0 auto; background-color: #E9E9E9; line-height: 100%;
        ...
        <span class="style3" style="display: block; text-align: right; padding-top: 15px;">&nbsp;&#1502;&#1499;&#1513;&#1497;&#1512;&#1497;
            &#1495;&#1513;&#1502;&#1500;</span>
        <hr />
        <br />
        <br />
...
WHERE (((TblDetailType.typeproname)='מכשירי חשמל'))
